...
namespace Com.OneSignal.iOS {
	...
	public unsafe partial class OSNotificationOpenedResult : NSObject {
		...
		static readonly NativeHandle class_ptr = Class.GetHandle ("OSNotificationOpenedResult");
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal OSNotificationOpenedResult (NativeHandle handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		public virtual OSNotificationAction Action {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<OSNotificationAction> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("action")))!;
				} else {
					ret =  Runtime.GetNSObject<OSNotificationAction> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("action")))!;
				}
				return ret!;
			}
		}
		...
		public virtual OSNotification Notification {
			...
			get {
				OSNotification? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<OSNotification> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("notification")))!;
				} else {
					ret =  Runtime.GetNSObject<OSNotification> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("notification")))!;
				}
				return ret!;
			}
		}
