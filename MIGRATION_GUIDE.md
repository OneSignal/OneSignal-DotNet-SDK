...
**Push Subscription**
The current device’s push subscription can be retrieved via `OneSignal.Default.User.PushSubscription`.  If at any point you want the user to stop receiving push notifications on the current device (regardless of platform permission status) you can use the push subscription to opt out:
...
**OneSignal**
The SDK is still accessible via a `OneSignal` static class (specifically, `OneSignal.Default`), it provides access to higher level functionality and is a gateway to each subspace of the SDK.

| **C#**                                                              | **Description**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `bool RequiresPrivacyConsent { get; set; }`                         | *Determines whether a user must consent to privacy prior to their user data being sent up to OneSignal.  This should be set to `true` prior to the invocation of [Initialize] to ensure compliance.*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `bool PrivacyConsent { get; set; }`                                 | *Indicates whether privacy consent has been granted. This field is only relevant when the application has opted into data privacy protections. See [RequiresPrivacyConsent].*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `event EventHandler<SubscriptionChangedEventArgs> PushSubscription.Changed`   | *Event for when the subscription has changed.*                                                                                                                                                                                           |
...
| `event EventHandler<NotificationWillDislpayEventArgs> WillDisplay`             | *Event for when a push notification will display.  The arguments contains [ToDisplayNotification] which will be used to determine whether to display a notification after all event handlers have been called.*                                    |
| `event EventHandler<NotificationClickedEventArgs> Clicked`                     | *Event for when a push notification has been clicked by the user.*                                                                                                                                                                                 |


**Location Namespace**
The location namespace is accessible via `OneSignal.Default.Location` and provide access to location-scoped functionality.
...
The In App Messages namespace is accessible via `OneSignal.Default.InAppMessages` and provide access to in app messages-scoped functionality.
...
**Debug Namespace**
The debug namespace is accessible via `OneSignal.Default.Debug` and provide access to debug-scoped functionality.
