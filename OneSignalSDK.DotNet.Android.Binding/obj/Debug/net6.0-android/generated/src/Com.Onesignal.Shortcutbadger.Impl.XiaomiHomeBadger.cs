...
namespace Com.Onesignal.Shortcutbadger.Impl {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='XiaomiHomeBadger']"
	[ObsoleteAttribute (@"This class is obsoleted in this android platform")]
	[global::Android.Runtime.Register ("com/onesignal/shortcutbadger/impl/XiaomiHomeBadger", DoNotGenerateAcw=true)]
	public partial class XiaomiHomeBadger : global::Java.Lang.Object, global::Com.Onesignal.Shortcutbadger.IBadger {
		// Metadata.xml XPath field reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='XiaomiHomeBadger']/field[@name='EXTRA_UPDATE_APP_COMPONENT_NAME']"
		[Register ("EXTRA_UPDATE_APP_COMPONENT_NAME")]
		public const string ExtraUpdateAppComponentName = (string) "android.intent.extra.update_application_component_name";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='XiaomiHomeBadger']/field[@name='EXTRA_UPDATE_APP_MSG_TEXT']"
		[Register ("EXTRA_UPDATE_APP_MSG_TEXT")]
		public const string ExtraUpdateAppMsgText = (string) "android.intent.extra.update_application_message_text";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='XiaomiHomeBadger']/field[@name='INTENT_ACTION']"
		[Register ("INTENT_ACTION")]
		public const string IntentAction = (string) "android.intent.action.APPLICATION_MESSAGE_UPDATE";

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/onesignal/shortcutbadger/impl/XiaomiHomeBadger", typeof (XiaomiHomeBadger));
		...
		protected XiaomiHomeBadger (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='XiaomiHomeBadger']/constructor[@name='XiaomiHomeBadger' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe XiaomiHomeBadger () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Onesignal.Shortcutbadger.Impl.XiaomiHomeBadger> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IList<string>? SupportLaunchers {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='XiaomiHomeBadger']/method[@name='getSupportLaunchers' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='XiaomiHomeBadger']/method[@name='executeBadge' and count(parameter)=3 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.ComponentName'] and parameter[3][@type='int']]"
