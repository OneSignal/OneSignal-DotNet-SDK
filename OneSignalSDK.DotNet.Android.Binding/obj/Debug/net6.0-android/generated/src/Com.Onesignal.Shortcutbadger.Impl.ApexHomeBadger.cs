...
namespace Com.Onesignal.Shortcutbadger.Impl {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='ApexHomeBadger']"
	[global::Android.Runtime.Register ("com/onesignal/shortcutbadger/impl/ApexHomeBadger", DoNotGenerateAcw=true)]
	public partial class ApexHomeBadger : global::Java.Lang.Object, global::Com.Onesignal.Shortcutbadger.IBadger {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/onesignal/shortcutbadger/impl/ApexHomeBadger", typeof (ApexHomeBadger));
		...
		protected ApexHomeBadger (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='ApexHomeBadger']/constructor[@name='ApexHomeBadger' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ApexHomeBadger () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Onesignal.Shortcutbadger.Impl.ApexHomeBadger> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IList<string>? SupportLaunchers {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='ApexHomeBadger']/method[@name='getSupportLaunchers' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='ApexHomeBadger']/method[@name='executeBadge' and count(parameter)=3 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.ComponentName'] and parameter[3][@type='int']]"
