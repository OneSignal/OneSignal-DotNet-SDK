...
namespace Com.Onesignal.Shortcutbadger.Impl {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='AsusHomeBadger']"
	[global::Android.Runtime.Register ("com/onesignal/shortcutbadger/impl/AsusHomeBadger", DoNotGenerateAcw=true)]
	public partial class AsusHomeBadger : global::Java.Lang.Object, global::Com.Onesignal.Shortcutbadger.IBadger {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/onesignal/shortcutbadger/impl/AsusHomeBadger", typeof (AsusHomeBadger));
		...
		protected AsusHomeBadger (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='AsusHomeBadger']/constructor[@name='AsusHomeBadger' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe AsusHomeBadger () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Onesignal.Shortcutbadger.Impl.AsusHomeBadger> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IList<string>? SupportLaunchers {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='AsusHomeBadger']/method[@name='getSupportLaunchers' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='AsusHomeBadger']/method[@name='executeBadge' and count(parameter)=3 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.ComponentName'] and parameter[3][@type='int']]"
