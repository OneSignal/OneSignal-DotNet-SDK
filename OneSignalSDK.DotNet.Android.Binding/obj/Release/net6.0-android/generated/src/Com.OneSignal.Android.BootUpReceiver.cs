...
namespace Com.OneSignal.Android {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.onesignal']/class[@name='BootUpReceiver']"
	[global::Android.Runtime.Register ("com/onesignal/BootUpReceiver", DoNotGenerateAcw=true)]
	public partial class BootUpReceiver : global::Android.Content.BroadcastReceiver {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/onesignal/BootUpReceiver", typeof (BootUpReceiver));
		...
		protected BootUpReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.onesignal']/class[@name='BootUpReceiver']/constructor[@name='BootUpReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe BootUpReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.OneSignal.Android.BootUpReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.onesignal']/class[@name='BootUpReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
