...
namespace Com.Onesignal.Shortcutbadger.Impl {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='AdwHomeBadger']"
	[global::Android.Runtime.Register ("com/onesignal/shortcutbadger/impl/AdwHomeBadger", DoNotGenerateAcw=true)]
	public partial class AdwHomeBadger : global::Java.Lang.Object, global::Com.Onesignal.Shortcutbadger.IBadger {
		// Metadata.xml XPath field reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='AdwHomeBadger']/field[@name='CLASSNAME']"
		[Register ("CLASSNAME")]
		public const string Classname = (string) "CNAME";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='AdwHomeBadger']/field[@name='COUNT']"
		[Register ("COUNT")]
		public const string Count = (string) "COUNT";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='AdwHomeBadger']/field[@name='INTENT_UPDATE_COUNTER']"
		[Register ("INTENT_UPDATE_COUNTER")]
		public const string IntentUpdateCounter = (string) "org.adw.launcher.counter.SEND";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='AdwHomeBadger']/field[@name='PACKAGENAME']"
		[Register ("PACKAGENAME")]
		public const string Packagename = (string) "PNAME";

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/onesignal/shortcutbadger/impl/AdwHomeBadger", typeof (AdwHomeBadger));
		...
		protected AdwHomeBadger (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='AdwHomeBadger']/constructor[@name='AdwHomeBadger' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe AdwHomeBadger () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Onesignal.Shortcutbadger.Impl.AdwHomeBadger> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IList<string>? SupportLaunchers {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='AdwHomeBadger']/method[@name='getSupportLaunchers' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.onesignal.shortcutbadger.impl']/class[@name='AdwHomeBadger']/method[@name='executeBadge' and count(parameter)=3 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.ComponentName'] and parameter[3][@type='int']]"
