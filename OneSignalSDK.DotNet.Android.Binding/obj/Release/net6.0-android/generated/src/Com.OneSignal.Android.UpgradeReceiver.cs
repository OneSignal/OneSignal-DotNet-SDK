...
namespace Com.OneSignal.Android {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.onesignal']/class[@name='UpgradeReceiver']"
	[global::Android.Runtime.Register ("com/onesignal/UpgradeReceiver", DoNotGenerateAcw=true)]
	public partial class UpgradeReceiver : global::Android.Content.BroadcastReceiver {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/onesignal/UpgradeReceiver", typeof (UpgradeReceiver));
		...
		protected UpgradeReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.onesignal']/class[@name='UpgradeReceiver']/constructor[@name='UpgradeReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe UpgradeReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.OneSignal.Android.UpgradeReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.onesignal']/class[@name='UpgradeReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
