...
namespace OneSignalSDK.DotNet.Core.Notifications
{
    ...
    public class Notification
    {
        ...
        /// </summary>
        public Nullable<float> RelevanceScore { get; }

        /// <summary>
        /// (iOS Only) Whether content is mutable.
        /// </summary>
        public Nullable<bool> MutableContent { get; }

        /// <summary>
        /// (iOS Only) Whether content is available.
        /// </summary>
        public Nullable<bool> ContentAvailable { get; }
